...
@section('content')
    {{ Form::model($region, ['route' => ['admin.region.update', $region], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'files' => true]) }}
                                 ...
                                 <div class="col-lg-10">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
                                            @if ($region->image1)
                                                <img src="{{ asset("uploads/region/$region->image1") }}">
                                            @else
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
                                            ...
                                            @if ($region->image2)
                                                <img src="{{ asset("uploads/region/$region->image2") }}">
                                            @else
                                               <img src="http://placehold.it/200x150" alt="...">
                                            @endif
