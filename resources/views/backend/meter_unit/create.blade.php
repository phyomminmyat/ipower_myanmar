...
@section ('title', trans('labels.backend.meter_unit.management') . ' | ' . trans('labels.backend.meter_unit.create'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.meter_unit.create') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::open(['route' => 'admin.meter_units.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
