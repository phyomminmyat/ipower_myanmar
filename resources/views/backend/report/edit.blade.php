...
@section ('title', trans('labels.backend.report.management') . ' | ' . trans('labels.backend.report.edit'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.report.edit') }}</small>
    </h1>
@endsection

@section('content')
    {{ Form::model($report, ['route' => ['admin.report.update', $report], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.report.edit') }}</h3>
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                                    ...
                                    <select class='form-control' name='report_type_id'>
                                        <option value="">Select</option>
                                         @foreach($report_types as $report_type)
                                            @if($report_type->id == $report->report_type_id)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    {{ Form::text('datetime', null, ['class' => 'form-control datepicker', 'autofocus' => 'autofocus', 'placeholder' => trans('validation.attributes.backend.report.datetime')]) }}
                                </div><!--col-lg-10-->
                            </div><!--form control-->
