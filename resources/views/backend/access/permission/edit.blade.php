...
@section ('title', trans('labels.backend.permission.management') . ' | ' . trans('labels.backend.permission.edit'))
...
@section('page-header')
    <h1>
        ...
        <small>{{ trans('labels.backend.access.permission.edit') }}</small>
    </h1>
@endsection

@section('content')
     {{ Form::model($permission, ['route' => ['admin.access.permissions.update', $permission], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.access.permission.edit') }}</h3>
                    ...
                    <div class="panel panel-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-1">
                                    {{ Form::checkbox('system', '1', $permission->system == 1) }}
                                </div><!--col-lg-1-->
                            </div><!--form control-->
