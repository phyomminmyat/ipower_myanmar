...
trait MeterOwnerAttribute
{
    ...
    {
        return '<a href="'.route('admin.meter_owner.edit', $this).'" class="btn btn-xs btn-primary"><i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="'.trans('buttons.general.crud.edit').'"></i></a> ';
    }
